...
const Article = () => {
    return (
        <article className='container mx-auto p-6'>
            <h2 className='text-2xl font-bold '>🗞️Latest News</h2>
            <div className='flex shadow-lg bg-white p-4 rounded-lg'>
                <img className='rounded-lg' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQH41aVG76krM8axGOxgeE0cd6L9TXvCwoAw&s" alt="News Image" />
                <div className='ml-4'>
