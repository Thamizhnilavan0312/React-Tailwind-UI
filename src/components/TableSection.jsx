                ...
                <tbody>
                    {TableData.map((user, index) => (
                        <tr key={index}>
                            ...
                            <td className={`border border-gray-300 px-4 py-2 ${user.Status === "Active" ? "text-green-500 font-semibold" : "text-red-500 font-semibold"} `}>{user.Status}</td>
